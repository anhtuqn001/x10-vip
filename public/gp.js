...
const gatewayMerchantId = 'exampleGatewayMerchantId'; // @todo: define
/**
...
function getGooglePaymentDataRequest() {
  ...
  paymentDataRequest.merchantInfo = {
    ...
    merchantName: 'Example Merchant' //TODO: to define
  };
...
function getGooglePaymentsClient() {
  if (paymentsClient === null) {
    paymentsClient = new google.payments.api.PaymentsClient({
      environment: 'TEST' // TODO: change to production after approval
    });
  }
...
function addGooglePayButton() {
  ...
  const button =
    ...
    // TODO: Verify
  document.getElementById('buy-button-container').appendChild(button);
}
 ...
 */
// TODO: update currency & the total
